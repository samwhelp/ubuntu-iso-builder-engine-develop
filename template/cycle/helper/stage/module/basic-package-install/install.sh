...
################################################################################
### Head: Model / mod_module_basic_package_install
##

sys_module_basic_package_install_combine_list () {
	...
	local package_install_dir_path="${REF_MASTER_BASIC_PACKAGE_INSTALL_DIR_PATH}"
...
sys_module_basic_package_install_load_list () {
...
sys_module_basic_package_install () {

	##util_error_echo
	##util_error_echo apt-get install -y --no-install-recommends $(sys_module_basic_package_install_load_list)
	##util_error_echo
	##apt-get install -y --no-install-recommends $(sys_module_basic_package_install_load_list)


	local package_install_list=$(sys_module_basic_package_install_load_list)
...
mod_module_basic_package_install () {
...
##
### Tail: Model / mod_module_basic_package_install
################################################################################
